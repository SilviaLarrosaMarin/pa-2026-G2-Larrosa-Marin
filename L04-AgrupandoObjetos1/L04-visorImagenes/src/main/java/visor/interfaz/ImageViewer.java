...
import visor.filtros.DarkerFilter;
import visor.filtros.EdgeFilter;
import visor.filtros.FishEyeFilter;
import visor.filtros.GrayScaleFilter;
import visor.filtros.InvertFilter;
import visor.filtros.LighterFilter;
import visor.filtros.MirrorFilter;
import visor.filtros.PixelizeFilter;
import visor.filtros.SmoothFilter;
import visor.filtros.SolarizeFilter;
import visor.filtros.ThresholdFilter;
import visor.imagen.OFImage;
import visor.menuFicheros.ImageFileManager;
import visor.filtros.Filter;
...
public class ImageViewer
{
    ...
    {
        frame = new JFrame("ImageViewer Prácticas PA");
